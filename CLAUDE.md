# CLAUDE.md — The Deviant's Chronicle v2
...
- **Izquierda**: VIGOR (20 casillas 2 filas), CONSTITUCIÓN (10 casillas), CORDURA (nested grid `110px auto 40px auto`), VOLUNTAD — contenido agrupado a la izquierda de la mitad
- **Derecha**: AUTOCONTROL / ALERTA / VALENTÍA alineadas por fila, separadas con borde izquierdo sutil
- `SquareStat` tiene tamaño fijo (CELL_SIZE=26px), no se estira
...
### Sub-tabs
- **CLAN**: botones de clan (coloreados al activarse) + grid de categorías con StatDiamond
- **ESFERAS**: 4 paneles (LUZ / OSCURIDAD / CAOS / ORDEN) + sección COMBINADAS debajo

### Círculos de esferas
- 4 círculos magenta marcables encima de cada panel de esfera
...
virtudes:   { autocontrol, alerta, valentia } → { val, blocked, cd, costo }
...
metapsicosis: 0  |  capacidadCarga: 0  |  piezasMejoras: ''
```
